...
const Education = () => {
  ...
  return (
    <div>
      <div class="  bg-white-200 rounded-xl rounded-lg shadow-lg ">
        <button
          type="button"
        ...
        <div>
          ...
          >
            I am Jane, a passionate individual who pursued my education at the
            prestigious MIT. During my
            time at MIT, I immersed myself in various cutting-edge courses and
            research projects, fostering a deep understanding of technology and
            innovation. 
          </p>
        </div>
